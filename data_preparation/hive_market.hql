...
CREATE EXTERNAL TABLE yvesyang_market_csv(
    period_begin string,
    period_end string,
...
SELECT period_begin, period_end, region, median_sale_price from yvesyang_market_csv limit 5;

-- Create an ORC table for the above data
CREATE TABLE yvesyang_market_orc(
    period_begin string,
    period_end string,
    period_duration tinyint,
    region_type string,
...
INSERT OVERWRITE TABLE yvesyang_market_orc
SELECT * 
FROM yvesyang_market_csv
